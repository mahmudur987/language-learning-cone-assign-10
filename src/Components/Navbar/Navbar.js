                                ...
                                <div className=' flex flex-col  items-center'>
                                    <Link to={'/profile'}>  <img className='w-10 rounded-3xl '
                                        src={user ? user.photoURL
                                            : 'https://w7.pngwing.com/pngs/340/956/png-transparent-profile-user-icon-computer-icons-user-profile-head-ico-miscellaneous-black-desktop-wallpaper.png'} alt="" /> <p className='text-xs'>profile</p> </Link>
